...
- 主頁中採用使用者在不同裝置尺寸時，以純 CSS 做到在兩個 About 連結中切換顯示；使用手機將前往 GitHub README 頁面，使用平板或電腦將前往履歷頁面。另外，在履歷頁面中使用自製右鍵選單，解決導覽列 (Navbar) 佔版面、鼠標移動距離較長 (費茲定律) 的問題，達到更簡潔的視覺版面與更加順暢的使用體驗
