...
class Portfolio {
	...
	// TODO: 平滑滾動 https://stackoverflow.com/questions/47011055/smooth-vertical-scrolling-on-mouse-wheel-in-vanilla-javascript
	scrollSmoothly(el, pixel, delay) {
		...
		if ( step < pixel) {
			...
			setTimeout(() => {
				this.scrollSmoothly(el, pixel - step, delay)
			}, intervalToRepeat);
		}
	}
